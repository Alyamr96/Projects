...
// this method checks if the visitor chooses an already exisiting username.
module.exports.checkUsername = function(req, res, next){
    //checks if the username the visitor chose is a string
    ...
    if (!valid){
        ...
        // checks if the username the visitor chose already exists returns a response saying that he already exists.
